...
public class LoadRecuReport {
	...
	@RequestMapping(value = "generateOpRecu/{id}/{format}")
	public String generateReport(@PathVariable String id, @PathVariable String format, HttpServletRequest request,HttpServletResponse response)  {
		String reportFileName = "recu";
		...
		try {
			...
			conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/wallet2.0","root","@2016@Wallet@2.0");
			...
			String rptFormat = format;
			String idOperation = id;

			//Parameters as Map to be passed to Jasper
			HashMap<String,Object> hmParams=new HashMap<String,Object>();

			hmParams.put("idoperation", idOperation);
